...
  return (
    <section ref={ref} className="relative h-[85vh] sm:h-[90vh] overflow-hidden flex items-center justify-center bg-gray-950">
...
      {/* Hero Text Content */}
        <motion.div style={{ y: textY, opacity }} className="relative text-center text-white px-4 w-full max-w-4xl mx-auto z-10 flex flex-col items-center">        
        {/* Badge */}
        <motion.span 
