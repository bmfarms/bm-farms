  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col justify-between overflow-hidden">
      <div>
        ...
        {/* Leadership Section - Option B (White Card with Slide-Up Drawer) */}
        <section className="py-20 bg-white border-t border-gray-100 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="max-w-md mx-auto bg-gray-50/80 border border-gray-200/90 rounded-3xl p-8 text-center shadow-lg hover:shadow-2xl transition-all duration-500 relative overflow-hidden group cursor-pointer"
            >
              {/* Top Accent Line */}
              ...
              {/* Collapsible Content Drawer (Expands smoothly on Hover) */}
              <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-all duration-500 ease-in-out">
                <div className="overflow-hidden">
                  <p className="mt-4 pt-4 text-sm text-gray-600 leading-relaxed border-t border-gray-200/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
